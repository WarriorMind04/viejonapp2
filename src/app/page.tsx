        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-800 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Announcing our next album.{" "}
              <a href="#" className="font-semibold text-[#558C99]">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-[#558C99] px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-[#916A80] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Tickets
              </a>
              <a href="#" className="text-sm/6 font-semibold text-gray-900">
